...
namespace SGGames.Scripts.Player
{
    public class PlayerGun : MonoBehaviour
    {
        ...
        private int m_shootHorizontalAnimParam = Animator.StringToHash("ShootHorizontal");
        private int m_shootVerticalAnimParam = Animator.StringToHash("ShootVertical");
        ...
        private void Shoot()
        {
            ...
            {
                m_animator.SetTrigger(m_shootHorizontalAnimParam);
            }
            else
            {
                m_animator.SetTrigger(m_shootVerticalAnimParam);
            }
